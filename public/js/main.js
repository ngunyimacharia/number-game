...
function checkGuess() {
  ...
  if (userGuess === randomNumber) {
    ...
    if(userGuess < randomNumber) {
      ...
      if(userGuess > minGuess){minGuess = userGuess; }
    } else if(userGuess > randomNumber) {
      lowOrHi.textContent = 'Last guess was too high!';
      if(userGuess < maxGuess){maxGuess = userGuess; }
    }
  }
...
feelingLucky.addEventListener('click',guessNumber);
